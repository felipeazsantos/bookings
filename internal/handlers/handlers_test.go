...
var theTests = []struct {
	...
	{"generals quarters", "/rooms/generals", "GET", []postData{}, http.StatusOK},
	{"majors suite", "/rooms/majors", "GET", []postData{}, http.StatusOK},
	...
	{"all res", "/admin/reservations-all", "GET", []postData{}, http.StatusOK},
...
func TestRepository_PostReservation(t *testing.T) {
	...
	reqBody = fmt.Sprintf("%s&%s", reqBody, "phone=555-545-5545")
...
func TestRepository_AvailableJson(t *testing.T) {
	...
	if j.OK {
		t.Error("Room is available when should not")
	}
}
...
func TestLogin (t *testing.T) {
	...
	for _, e := range loginTests {
		...
		// checking for expeted values in HTML
		if e.expectedHTML != "" {
